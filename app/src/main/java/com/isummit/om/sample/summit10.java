...
public class summit10 extends AppCompatActivity {
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference myRef = database.getReference("third");
    StorageReference storageReference= FirebaseStorage.getInstance().getReference("2011/group.jpg");
    StorageReference st= FirebaseStorage.getInstance().getReference("2011/picture_2_a.jpg");
