...
public class summit11 extends AppCompatActivity {
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference myRef = database.getReference("fourth");
    StorageReference storageReference= FirebaseStorage.getInstance().getReference("2010/excellence_in_innovaIAz22.jpg");
    StorageReference st= FirebaseStorage.getInstance().getReference("2010/tata_tech_1_.jpg");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summit11);

        Toolbar mToolbar =  findViewById(R.id.toolbar);
        mToolbar.setTitle("3I Summit 2011");
