...
public class AgendaRecyclerAdapterSummit extends RecyclerView.Adapter<AgendaRecyclerAdapterSummit.ViewHolder> {
    ...
    public AgendaRecyclerAdapterSummit(Context context, List agenda_time, List agenda_msg) {
    ...
    @Override
    public AgendaRecyclerAdapterSummit.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        ...
        AgendaRecyclerAdapterSummit.ViewHolder viewHolder = new AgendaRecyclerAdapterSummit.ViewHolder(context,itemLayoutView);
        return viewHolder;
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(AgendaRecyclerAdapterSummit.ViewHolder viewHolder, int position) {
