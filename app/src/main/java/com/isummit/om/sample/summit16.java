...
public class summit16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summit16);
        Toolbar mToolbar = findViewById(R.id.toolbar);

        mToolbar.setTitle("3I Summit 2016");
        ...
        myRef=FirebaseDatabase.getInstance().getReference("nineth");
    ...
    private void init() {
        ...
        mPager.setAdapter(new MyAdapter(summit16.this,XMENArray));
