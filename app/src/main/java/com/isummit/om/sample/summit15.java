...
public class summit15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summit15);
        Toolbar mToolbar = findViewById(R.id.toolbar);

        mToolbar.setTitle("3I Summit 2015");
        ...
        myRef=FirebaseDatabase.getInstance().getReference("eighth");
    ...
    private void init() {
        ...
        mPager.setAdapter(new MyAdapter(summit15.this,XMENArray));
