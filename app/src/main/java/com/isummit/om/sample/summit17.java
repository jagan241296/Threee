...
public class summit17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summit17);
        Toolbar mToolbar = findViewById(R.id.toolbar);

        mToolbar.setTitle("3I Summit 2017");
        ...
        myRef=FirebaseDatabase.getInstance().getReference("tenth");
    ...
    private void init() {
        ...
        mPager.setAdapter(new MyAdapter(summit17.this,XMENArray));
