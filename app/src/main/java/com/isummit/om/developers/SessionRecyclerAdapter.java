...
public class SessionRecyclerAdapter extends RecyclerView.Adapter<SessionRecyclerAdapter.ViewHolder> {
    public List<String> session_room;
    public List<String> session_speaker;
    private Context context;



    // Provide a suitable constructor (depends on the kind of dataset)
    public SessionRecyclerAdapter(Context context, List session_room, List session_speaker) {
    ...
    @Override
    public SessionRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        ...
        SessionRecyclerAdapter.ViewHolder viewHolder = new SessionRecyclerAdapter.ViewHolder(context,itemLayoutView);
        return viewHolder;
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(SessionRecyclerAdapter.ViewHolder viewHolder, int position) {

        // - get data from your itemsData at this position
        // - replace the contents of the view with that itemsData

        viewHolder.agenda_time.setText(session_room.get(position));
        viewHolder.agenda_msg.setText(session_speaker.get(position));
